...
class BookingTest {
    ...
    void talkback() {
        ...
        assertTrue(Booking.createPremiumBooking(talkbackShow, peekDay, premiumExtra).premiumDelegate.hasTalkback());
        assertFalse(Booking.createPremiumBooking(noTalkbackShow, peekDay, premiumExtra).premiumDelegate.hasTalkback());
    }
